...
export default function QuizContainer({quizState, setQuizState}) {
  ...
  const [quizApiOptions, setQuizApiOptions] = useState({ number: '10', category: '9', difficulty: 'easy' })
  ...
  function everyAnswer() {
    if (
      quizDisplay.slice(quizCurrentSet.current, quizCurrentSet.current + 4)
